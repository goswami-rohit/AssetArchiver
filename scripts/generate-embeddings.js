...
const endpoints = [
  ...
  {
    id: 3,
    name: "List Recent Dealers",
    endpoint: "/api/dealers/recent",
    method: "GET",
    description: "List all available dealers with filtering and pagination options",
    fields: [
      "limit", "userId", "id", "type", "parentDealerId", "name", "region", "area",
      "phoneNo", "address", "totalPotential", "bestPotential", "brandSelling",
      "feedbacks", "remarks", "createdAt", "updatedAt"
    ],
    requiredFields: [],
    searchTerms: "dealers list recent get dealers fetch dealers dealer management dealer data"
  }
