...
// import { Bell, User, MessageCircle, X, Trash2, Send, Clock, CheckCircle, XCircle, BarChart3 } from "lucide-react";
...
// type TabType = "dashboard" | "inquiries" | "vendors" | "analytics" | "bot-config" | "api" | "api-keys" | "office-management"; // Add office-management;
...
export default function Dashboard() {
  ...
  //   vendors: "Manage employee profiles, approvals, and 14-feature access",
  //   "office-management": "Manage office locations and geofencing settings", // Add this line
  ...
  //                   <p className="font-medium mb-2">Weekly Attendance Chart</p>
  //                   <p className="text-sm">Coming Soon - Chart Integration</p>
  //                 </div>
  //               </CardContent>
  //             </Card>
  ...
  //                     <p className="text-slate-500 font-medium">No employee data yet</p>
  //                     <p className="text-sm text-slate-400">Performance metrics will appear here once employees start using the system</p>
  //                   </div>
  //                 </div>
  //               </CardContent>
  //             </Card>
  ...
  //                       <Badge variant="outline">0 uses</Badge>
  //                     </div>
  //                   ))}
  //                 </div>
  //               </CardContent>
  ...
  //                   <p className="text-sm text-slate-400">Employee activities will be tracked here</p>
  //                 </div>
  //               </CardContent>
  //             </Card>
  ...
  //                     Reports will be available once employee data is collected
  //                   </p>
  //                 </div>
  //               </CardContent>
  //             </Card>
  ...
  return ( 0 // DASHBOARD component is not being used : WIll remove later
